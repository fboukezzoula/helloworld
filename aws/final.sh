...
# En-tête CSV
echo "AccountId,Region,VpcId,Name,Cidr,Default" > "$OUTPUT_FILE"

# Liste des comptes actifs de l'Organization
...
for ACCOUNT_ID in $ACCOUNTS; do
  ...
  for REGION in $REGIONS; do
    ...
    while read -r VPC_ID NAME CIDR DEFAULT; do
      echo "$ACCOUNT_ID,$REGION,$VPC_ID,$NAME,$CIDR,$DEFAULT" >> "$OUTPUT_FILE"
    done
  done
